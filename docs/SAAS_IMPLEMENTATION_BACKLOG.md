...
5. Add basic dashboard shell after login. The API now exposes local owner-organization onboarding and user organization listing routes that can back the first authenticated shell.
